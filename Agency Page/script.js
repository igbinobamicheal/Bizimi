document.addEventListener("DOMContentLoaded", () => {
      ...
      roleCards.forEach(card => {
          card.addEventListener('click', () => {
              ...
              if (role === 'agency') {
                  ...
                  if (companyNameInput) companyNameInput.setAttribute('required', 'true');
                  if (companySizeInput) companySizeInput.setAttribute('required', 'true');
  ...
  const skillsData = [
      ...
      "Software Development", "Game Development", "Blockchain Development",
      "Data Science", "Machine Learning", "DevOps", "Cloud Computing", "Cybersecurity", 
  ...
  if (skillSearch && skillsDropdown && selectedSkillsList) {
      ...
      document.addEventListener('click', (e) => {
          if (!skillSearch.contains(e.target) && !skillsDropdown.contains(e.target)) {
      ...
      function renderDropdown(filter = "") {
          ...
          let matches = skillsData.filter(skill => 
              skill.toLowerCase().includes(lowerFilter) && !selectedSkills.includes(skill)
          );
      ...
      function renderSelectedSkills() {
          ...
          selectedSkills.forEach(skill => {
              ...
              pill.querySelector('.skill-remove-btn').addEventListener('click', (e) => {
                  e.stopPropagation();
                  removeSkill(skill);
              });
